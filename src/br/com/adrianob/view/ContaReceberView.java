 ...
 */
public class ContaReceberView extends javax.swing.JFrame implements ActionListener {

    ListaContaView lcv;
    CadastroPessoa cp;

    private ContaReceber contaReceberSelecionada;

    public static final String PROP_CONTARECEBERSELECIONADA = "contaReceberSelecionada";

    public ContaReceber getContaReceberSelecionada() {
        return contaReceberSelecionada;
    }

    public void setContaReceberSelecionada(ContaReceber contaReceberSelecionada) {
        ContaReceber oldContaReceberSelecionada = this.contaReceberSelecionada;
        this.contaReceberSelecionada = contaReceberSelecionada;
    ...
    private void initComponents() {
        ...
        listaCR = ObservableCollections.observableList(new ArrayList<ContaReceber>());
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listaCR, tbLista);
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Contas a Receber"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${contaReceberSelecionada.dataRecebimento}"), txtDtRecebimento, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setConverter(new br.com.adrianob.services.ConverterDate());
        bindingGroup.addBinding(binding);
        ...
        jcbSituacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aberta", "Recebida" }));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${contaReceberSelecionada.valorRecebido}"), txtValorRecebido, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        listaCR.add(new ContaReceber());
        atualizaLista();
        txtDocumento.requestFocus();
    }//GEN-LAST:event_btnNovoActionPerformed

    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        DaoGenerico.getInstance().salvarOuRemover(listaCR, DaoGenerico.SALVAR);
        DaoGenerico.getInstance().closeEm();
    }//GEN-LAST:event_btnSalvarActionPerformed

    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (contaReceberSelecionada != null) {
            if (contaReceberSelecionada.getId() > 0) {
                ArrayList<ContaReceber> cts = new ArrayList<ContaReceber>();
                cts.add(contaReceberSelecionada);
                DaoGenerico.getInstance().salvarOuRemover(cts, DaoGenerico.REMOVER);
            }
            listaCR.remove(contaReceberSelecionada);
            atualizaLista();
        }
    }//GEN-LAST:event_btnExcluirActionPerformed

    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        List<ContaReceber> lst = DaoGenerico.getInstance().listar("Select c from br.com.adrianob.model.ContaReceber c",
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContaReceberView().setVisible(true);
            }
        });
    }
    ...
    private java.util.List<ContaReceber> listaCR;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equalsIgnoreCase("selecionar")) {
            if (lcv != null) {
                contaReceberSelecionada.setConta(lcv.getContaSelecionada());
                lcv.dispose();
            }
        }
        if (e.getActionCommand().equalsIgnoreCase("selecionarPessoa")) {
            if (cp != null) {
                contaReceberSelecionada.setPessoa(cp.getPessoaSelecionada());
                cp.dispose();
            }
        }
    }
